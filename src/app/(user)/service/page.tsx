...
const WHATSAPP_MESSAGE = 'Hello, I need help with my Simple Money account.';
                    ...
                    <div className="relative z-10 space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-text-secondary text-xs uppercase font-bold tracking-[0.15em] opacity-60">
                                Simple Money technicians are monitoring system processes in real-time. Choose a dedicated channel below.
                            </p>
                        </div>
                    </div>
