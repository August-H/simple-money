...
const FAQS = [
    {
        ...
        icon: Globe,
        q: "What is Simple Money?",
        a: "Simple Money is an AI collaboration platform that bridges the gap between neural network models and human verification. We provide structured data verify by global contributors to ensure the accuracy and safety of modern AI systems."
    },
    {
