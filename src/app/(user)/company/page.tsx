...
const timeline = [
    ...
    { year: '2026', event: 'Simple Money: Global release of consumer-facing match hub' },
];
        ...
        <div className="max-w-4xl mx-auto pb-20 animate-fade-in space-y-10">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-text-secondary text-xs mt-1 font-bold uppercase tracking-widest font-mono opacity-60">Simple Money Global Ops</p>
                </div>
                ...
                <div className="relative z-10 flex flex-col md:flex-row gap-12 items-center">
                    ...
                    <div className="space-y-4 text-center md:text-left">
                        ...
                        <p className="text-text-secondary text-sm leading-relaxed max-w-xl font-medium">
                            Simple Money operates at the intersection of decentralised workforce management and cutting-edge neural network optimization. 
